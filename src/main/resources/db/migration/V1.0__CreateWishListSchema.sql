...
-- Mon 04 Oct 2021 07:52:49 AM -03
...
CREATE TABLE IF NOT EXISTS `wlist`.`WISH_LIST` (
  ...
  `OPENED` CHAR(1) NOT NULL DEFAULT 1 COMMENT 'Indicator if the list is open or closed. Allowed values are Y-Yes or N-No.',
